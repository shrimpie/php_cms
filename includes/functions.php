<?php
	...
	function navigation($subject_array, $page_array, $public=true) {
		...
		while($subject = mysqli_fetch_assoc($subject_set)) {
			...
			$output .= "<a href=\"";
			$output .= $public ? "index.php?subject=" : "manage_content.php?subject=";
			$output .= urlencode($subject["id"]);
			$output .= "\">";
			$output .= htmlentities($subject["menu_name"]);
			$output .= "</a>";

			if(!$public || ($public && ($subject_array["id"] == $subject["id"] 
				...
				while($page = mysqli_fetch_assoc($page_set)) {
					...
					$output .= ">";
					$output .= $public ? "<a href=\"index.php?page=" : "<a href=\"manage_content.php?page=";
	...
	function generate_page_list($page_set, $url) {
